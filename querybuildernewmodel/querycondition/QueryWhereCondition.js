Ext.define('Buzzor.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Buzzor.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],

Ext.define('Buzzor.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Buzzor.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Buzzor.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Buzzor.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Buzzor.view.querybuildernewmodel.querydetail.QueryDetail');

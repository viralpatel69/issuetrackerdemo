Ext.define('Buzzor.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Buzzor.view.querybuildernewmodel.queryentities.QueryEntitiesController'],

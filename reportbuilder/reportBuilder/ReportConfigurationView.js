Ext.define('Buzzor.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Buzzor.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Buzzor.view.reportbuilder.gridconfig.GridConfigView',
	           'Buzzor.view.reportbuilder.properties.PropertiesPanelView',
	           'Buzzor.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {

Ext.define('Buzzor.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Buzzor.view.reportbuilder.reportlist.ReportListPanelView',
             'Buzzor.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Buzzor.view.reportbuilder.mainview.ReportMainController'
             ],

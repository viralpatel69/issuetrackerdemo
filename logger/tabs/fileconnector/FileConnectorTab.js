 ...
 * 
 */
Ext.define('Buzzor.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Buzzor.view.logger.tabs.fileconnector.FileConnectorTabController'],
	...
	items : [{
			...
			},
			{
			...
			},
	         {
	        			...
	        			value : 'com.buzzor.log.connectors.file.FileConnector'
	        }, {
	        			xtype : 'hidden',

 ...
 * 
 */
Ext.define('Buzzor.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Buzzor.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
	...
	},
	{
		...
		value : 'com.buzzor.log.connectors.syslog.SyslogConnector'
	},{
		xtype : 'hidden',
		name : 'syslogCid',
		itemId : 'syslogCid',

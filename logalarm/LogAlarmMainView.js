 ...
 * 
 */
Ext.define('Buzzor.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Buzzor.view.logalarm.LogAlarmMainViewController',
			'Buzzor.view.logalarm.tree.LogAlarmTreePanel',
			'Buzzor.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',

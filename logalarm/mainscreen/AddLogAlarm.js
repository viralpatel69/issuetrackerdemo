 ...
 * 
 */
Ext.define('Buzzor.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Buzzor.view.logalarm.mainscreen.AddLogAlarmController',
			'Buzzor.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Buzzor.view.logalarm.mainscreen.AppAlarmPanel',
	...
	items : [ {
		...
		items : [ {
			...
			items : [ {
				...
				bind : {
				// disabled: '{!isConnectorOrder.isValid()}'
				}
			} ]
		}, {
			xtype : 'fieldcontainer',

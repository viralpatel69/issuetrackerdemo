 ...
 * 
 */
Ext.define('Buzzor.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Buzzor.view.securityconfig.SecurityConfigController',
			'Buzzor.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',

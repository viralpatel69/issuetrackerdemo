 ...
 * 
 */
Ext.define('Buzzor.view.securityconfig.SecurityQuestionController', {
	...
	init : function()
	{
		...
		Ext.Ajax.request({
			timeout: 6000000,
			url : 'secure/AstPasswordSecurityQuestion/findAll',
			method : 'GET',
			jsonData : {},
	...
	addQuestionToGrid : function(questions)
	{
		...
		for(var i = 0; i<questions.length; i++)
		{
			...
			var rec = {"questionId" : question.questionId, "levelid" : question.levelid, "question" : question.question, "questionDetails" : question.questionDetails}
	...
	updateSecurityQuestions : function()
	{
		...
		Ext.Ajax.request({
			timeout: 6000000,
			url : 'secure/AstPasswordSecurityQuestion/updateAll',

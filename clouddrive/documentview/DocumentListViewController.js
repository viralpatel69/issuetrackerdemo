...
Ext.define('Buzzor.view.clouddrive.documentview.DocumentListViewController',{
	extend : 'Ext.app.ViewController',
	requires:['Buzzor.view.fw.PDF.panel.PDF'],
						...
						hierarchy.length > 0 ? "": '-',
							  ...
							  nodesHieraObj[nodesHieraObj.length - 1].data.ftId == -2
												&& hierarchy.length == 0 ? Ext.create('Ext.Action',
															...
															: "",
					 hierarchy.length > 0 ? "": "-",hierarchy.length > 0 ? "": Ext.create('Ext.Action',
																			{

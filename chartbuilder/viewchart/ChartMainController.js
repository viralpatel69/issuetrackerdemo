Ext.define('Buzzor.view.chartbuilder.viewchart.ChartMainController',{
    ...
    onSaveChartClick:function()
    {
	    ...
	    if(radioChecked==true)
	    {
		    ...
		    // Value Field
		    if(gFieldPanel.query("[comboType=numeric]")[0]!=undefined){
		    	if(gFieldPanel.query("[comboType=numeric]")[0].getValue()==null){
		    		errorMsg=errorMsg+"Enter Value Field<br>";
		    	}
		    	chartJson.value=gFieldPanel.query("[comboType=numeric]")[0].getValue();
		    }
		    //Aggregate Field
